...
$sql = "SELECT * FROM tahsisler WHERE kullanici_id = '$kullanici_id' AND baslangic_zamani <= '$suan' AND bitis_zamani >= '$suan' ORDER BY id DESC LIMIT 1";
